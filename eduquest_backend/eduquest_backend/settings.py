"""
Django settings for eduquest_backend project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Register ve Login için izin veriyoruz
    ],
}
# CORS settings
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'your-secret-key',  # SECRET_KEY kullanabilirsiniz
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
...
# Contract ABI dosya yolu
import os
NFT_CONTRACT_ABI = os.path.join(BASE_DIR, 'contract_abis/EduQuestNFT.json')