# Generated by Django 5.0.3 on 2025-01-05 00:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.CharField(choices=[('primary', 'Primary School'), ('secondary', 'Secondary School'), ('high', 'High School'), ('university', 'University'), ('professional', 'Professional')], max_length=20, null=True)),
                ('interests', models.JSONField(blank=True, default=dict)),
                ('points', models.IntegerField(default=0)),
                ('completed_courses', models.JSONField(blank=True, default=list)),
                ('owned_nfts', models.JSONField(blank=True, default=list)),
                ('achievements', models.JSONField(blank=True, default=list)),
                ('quiz_history', models.JSONField(blank=True, default=list)),
